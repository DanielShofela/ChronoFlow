...
export function DailyVerse({ verse }: DailyVerseProps) {
  ...
  return (
    ...
    >
      <Quote className="absolute top-2 left-2 w-8 h-8 text-muted/20 transform -translate-x-1/4 -translate-y-1/4" />
      ...
      <Quote className="absolute bottom-2 right-2 w-8 h-8 text-muted/20 transform translate-x-1/4 translate-y-1/4 rotate-180" />
    </motion.div>
  );
}